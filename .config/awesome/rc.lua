...
||\\
|| \\ 
||  \\LOCK's awesomewm config
https://www.unshackled.xyz
-------------------------------------
originally forked from awesome copy cats at https://github.com/lcpz
--]]
...
local gui_editor   = os.getenv("GUI_EDITOR") or ""
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey,           }, "i", function () awful.spawn("nitrogen") end,
    ...
    awful.key({ modkey,            }, "u", function () awful.spawn("joplin-desktop") end,
              {description = "joplin-desktop", group = "launcher"}),
    awful.key({ modkey,            }, "o", function () awful.spawn("keepassxc") end,
